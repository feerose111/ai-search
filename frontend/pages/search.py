...
from frontend.components.build_nl_query import build_query
from frontend.components.css_loader import load_css
from frontend.components.search_result import render_search_results
from frontend.components.search_history import render_search_history
    ...
    if st.button("Search", key="search_btn", use_container_width=True) and query:
        with st.spinner("Searching..."):
            try:
                ...
                response = requests.get(SEARCH_API, params={"q": full_query})
